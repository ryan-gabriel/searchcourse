    ...
    return (
        <div className="relative">
            <select
                ...
                className="appearance-none pl-3 pr-8 py-2.5 bg-surface border border-border rounded-lg text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-accent cursor-pointer"
            >
                {options.map((option) => (
